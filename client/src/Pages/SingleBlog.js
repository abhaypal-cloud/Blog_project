...
const SingleBlog = () => {
    ...
    useEffect(() => {
        const fetchSingleBlog = async () => {
            const res = await axios.get(`https://https-github-com-prabhatmunjal12-my-blog.onrender.com/api/v1/get/blog/${id}`, {
                headers: {
            ...
            <div className='container shadow my-3'>
                <div className='col-md-12 d-flex items-center justify-content-center bg-light'>
                    <div className='row'>
                        ...
                        <img src={`https://https-github-com-prabhatmunjal12-my-blog.onrender.com/${blog.thumbnail}`}
